...
| [`hub-app/`](hub-app/README.md) | `apps/hub-app` — a Tauri (desktop + mobile) shell around the same Hub UI, for guild/friend presence without a game client open. | Scaffolding/skeleton, not yet built out. |
