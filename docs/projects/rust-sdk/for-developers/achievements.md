...
and [`../../backend-server/architecture/trust-model.md`](../../backend-server/architecture/trust-model.md) — this
...
See [`../../backend-server/architecture/revocation.md`](../../backend-server/architecture/revocation.md) for
