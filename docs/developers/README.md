...
[`../projects/backend-server/architecture/`](../projects/backend-server/architecture/) for the concepts behind what you're
...
See also [`../projects/backend-server/architecture/sdk.md`](../projects/rust-sdk/architecture/sdk.md) for the SDK
design principle (protocol capabilities, not infrastructure),
[`../projects/backend-server/architecture/trust-model.md`](../projects/backend-server/architecture/trust-model.md) for what an
