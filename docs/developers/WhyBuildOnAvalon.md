...
[`../projects/backend-server/architecture/overview.md`](../projects/backend-server/architecture/overview.md) for current status);
...
A guild is a network-level entity ([`../projects/backend-server/architecture/guilds.md`](../projects/backend-server/architecture/guilds.md)),
...
[`../projects/backend-server/architecture/trust-model.md`](../projects/backend-server/architecture/trust-model.md)), durable
tournament and game-event results
([`../projects/backend-server/architecture/cross-integrator-events.md`](../projects/backend-server/architecture/cross-integrator-events.md)), and
...
([`../projects/backend-server/architecture/bindings.md`](../projects/backend-server/architecture/bindings.md)):
...
operate yourself — see [`../projects/backend-server/architecture/sdk.md`](../projects/rust-sdk/architecture/sdk.md).
...
its game, and it's part of what [`../projects/backend-server/architecture/disaster-recovery.md`](../projects/backend-server/architecture/disaster-recovery.md)
and the "what survives a game's death" table in
[`../projects/backend-server/architecture/README.md`](../projects/backend-server/architecture/README.md) are designed around.
...
independent developers, and — per [`../projects/backend-server/architecture/nodes.md`](../projects/backend-server/architecture/nodes.md)
...
conversations — see [`../projects/backend-server/architecture/sdk.md`](../projects/rust-sdk/architecture/sdk.md) for
...
[`../projects/backend-server/architecture/README.md`](../projects/backend-server/architecture/README.md) for the invariants
this is held to. For the actual integration surface once it exists, see
[`../projects/backend-server/architecture/sdk.md`](../projects/rust-sdk/architecture/sdk.md) and this directory's
`README.md`.
...
[`../projects/backend-server/architecture/self-hosting.md`](../projects/backend-server/architecture/self-hosting.md) covers
