...
//!
//! This boundary is mandatory rather than incidental: identity must survive
//! any single integrator shutting down.
...
pub struct Profile {
    ...
    /// page header. Same shape and same server-side validation
    ...
    /// no such crate exists in this workspace today; this is a
    ...
    /// IP-derived or geocoded. This is load-bearing: a future
